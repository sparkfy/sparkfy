...
class SparseVector(var indices: Array[Int], var values: Array[Double])
  ...
  private[sparkfy] var lastReturnedPos = -1
...
class MapVector(initCapacity: Int,
  ...
  private[sparkfy] var table: Array[Int] = Array.fill(capacity)(-1)
  private[sparkfy] var values: Array[Double] = Array.fill(capacity)(0)
