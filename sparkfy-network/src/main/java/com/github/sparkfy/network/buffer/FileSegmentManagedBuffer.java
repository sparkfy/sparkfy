...
import com.github.sparkfy.util.LimitedInputStream;
...
public final class FileSegmentManagedBuffer extends ManagedBuffer {
    ...
    public FileSegmentManagedBuffer(int memoryMapBytes, boolean lazyFileDescriptor, File file, long offset, long length) {
